 ...
 */
@ContentProvider(authority = QuoteProvider.AUTHORITY,
        database = QuoteDatabase.class,
        packageName = "com.intelliviz.stockhawk.data.provider")
public class QuoteProvider {
  public static final String AUTHORITY = "com.intelliviz.stockhawk.data.QuoteProvider";
